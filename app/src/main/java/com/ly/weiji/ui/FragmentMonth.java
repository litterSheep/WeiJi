...
import com.ly.weiji.db.AccountManager;
import com.ly.weiji.utils.PreferencesUtils;
import com.ly.weiji.utils.TimeUtil;
import com.ly.weiji.utils.ToastUtil;
import com.ly.weiji.view.AlertDialogList;
import com.ly.weiji.view.ChartMarkerView;
...
//        xAxis.setAxisMaximum(lastDayOfMonth+1);
    ...
    private void setLineData() {
        ...
        if (isOpenComparison) {
            ...
            if (entriesLastMonth == null || entriesLastMonth.size() == 0) {
                ToastUtil.showToast(getString(R.string.no_last_month_data));
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        if (!isShow) {
            ToastUtil.showToast(getString(R.string.long_click_show_dialog));
