...
// You can also override 'formatDate(Date)' & 'formatTime(Date)'
    ...
    public static SublimePickerFragment getInstance() {
        return new SublimePickerFragment();
    }
...
//                .getLayoutInflater().inflate(R.layout.sublime_picker1, container);
        mSublimePicker = new SublimePicker(getActivity());
